...
CREATE TABLE students (
    ...
    major VARCHAR(100),
    year ENUM('Level 100', 'Level 200', 'Level 300', 'Level 400') NOT NULL DEFAULT 'Level 100',
    date_of_birth DATE,
    phone VARCHAR(20),
...
CREATE TABLE appointments (
    ...
    status ENUM('pending', 'scheduled', 'completed', 'cancelled', 'no_show', 'rescheduled') NOT NULL DEFAULT 'pending',
