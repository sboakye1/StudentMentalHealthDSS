...
def register_routes(app):
    ...
    def register():
        if request.method == "POST":
            ...
            if counselor_id:
                ...
                cursor2.execute("SELECT user_id FROM counselors WHERE id = %s", (counselor_id,))
                counselor_row = cursor2.fetchone()
                assigned_counselor_user_id = counselor_row[0] if counselor_row else None
                if assigned_counselor_user_id:
    ...
    def counselor_approve_appointment(appointment_id):
        ...
        student_id = appointment_row[0] if appointment_row else None
        cursor.execute("""
            UPDATE appointments
